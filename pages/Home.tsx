  ...
  return (
    <div className="w-full relative">
      ...
      <section id="hero" className="min-h-screen flex flex-col justify-center px-6 pt-20 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[40vw] h-[40vw] bg-zinc-200 dark:bg-zinc-900 rounded-full blur-[120px] opacity-20 pointer-events-none" />
      ...
      {/* Value Statement */}
      <section id="values" className="py-32 border-t border-zinc-200 dark:border-zinc-900 bg-zinc-100/50 dark:bg-zinc-950/50">
      ...
      {/* Skills Grid */}
      <section id="skills" className="py-32 border-t border-zinc-200 dark:border-zinc-900">
      ...
      <section id="projects" className="py-32 border-t border-zinc-200 dark:border-zinc-900 bg-zinc-100/50 dark:bg-zinc-950/30">
        <div className="max-w-7xl mx-auto px-6">
          <RevealOnScroll>
      ...
      {/* CTA */}
      <section id="cta" className="py-40 border-t border-zinc-200 dark:border-zinc-900 flex flex-col items-center justify-center text-center px-6">
        <RevealOnScroll>
